...
def main():
    ...
    if code_input:
        with st.spinner("Analyzing code..."):
                ...
                with metrics_col1:
                    if 'complexity' in analysis_results and analysis_results['complexity']:
                        ...
                        if 'cyclomatic_complexity' in complexity_data:
                            avg_complexity = sum(c.complexity for c in complexity_data['cyclomatic_complexity']) / len(complexity_data['cyclomatic_complexity']) if complexity_data['cyclomatic_complexity'] else 0
            ...
            tab1, tab2, tab3, tab4 = st.tabs(["📝 Code Comparison", "📊 Complexity Details", "💡 All Suggestions", "📄 Export Report"])
                    ...
                    if 'cyclomatic_complexity' in analysis_results['complexity']:
                        ...
                        if complexity_data:
                            ...
                            if not high_complexity_functions.empty:
                                st.warning(f"⚠️ {len(high_complexity_functions)} functions have complexity > {complexity_threshold}")
            ...
            with tab4:
                ...
                report_data = {
                    ...
                    'metrics': {
                        ...
                        'maintainability_index': analysis_results.get('complexity', {}).get('maintainability_index', 'N/A'),
                        'lines_of_code': analysis_results.get('complexity', {}).get('raw_metrics', {}).get('lines_of_code', 'N/A'),
